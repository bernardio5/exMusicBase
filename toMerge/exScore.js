...
function exTabLine(aCanvas, score, line, secPerTile, whichLine) {
	this.ox = 0; // origin
	this.oy = 0; 
...
exScoreLine.prototype.drawPluck = function(string, fret, tm, ppn) { 
...
exScoreDisplay.prototype.drawSliderSprite = function(x, y, tx, ty) { 
    var ts = this.tileSize; 
    var is = this.imgTileSz
